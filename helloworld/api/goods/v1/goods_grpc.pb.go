...
const (
	Goods_AddGoods_FullMethodName = "/goods.v1.Goods/AddGoods"
)
...
func (c *goodsClient) AddGoods(ctx context.Context, in *AddGoodsRequest, opts ...grpc.CallOption) (*AddGoodsResponse, error) {
...
func (UnimplementedGoodsServer) AddGoods(context.Context, *AddGoodsRequest) (*AddGoodsResponse, error) {
...
func _Goods_AddGoods_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsServer).AddGoods(ctx, req.(*AddGoodsRequest))
	}
